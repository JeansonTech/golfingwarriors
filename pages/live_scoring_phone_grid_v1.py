...
st.markdown(
    ...
    @media (max-width: 768px) {
        ...
        /*
         * Streamlit normally stacks columns on narrow screens.
         * Live Scoring deliberately keeps its small column groups
         * horizontal so the hole selector remains a compact grid.
         */
...
st.markdown(
    f"""
    <div class="gw-card" style="padding:7px;margin-bottom:7px;">
...
for _, player in fourball.iterrows():
    ...
    st.markdown(
        '<div class="gw-card" style="padding:6px;margin-bottom:6px;">',
        unsafe_allow_html=True
    )
