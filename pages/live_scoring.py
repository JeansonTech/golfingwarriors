...
st.markdown(
    ...
    @media (max-width: 768px) {
        ...
        /* Keep the 9-hole button rows horizontal on phones. */
        div[data-testid="stHorizontalBlock"]:has(> div:nth-child(9)) {
            flex-wrap: nowrap !important;
            gap: 0.18rem !important;
        }

        div[data-testid="stHorizontalBlock"]:has(> div:nth-child(9)) div[data-testid="column"] {
            min-width: 0 !important;
            width: auto !important;
            flex: 1 1 0 !important;
        }

        div[data-testid="stHorizontalBlock"]:has(> div:nth-child(9)) div[data-testid="stButton"] > button {
